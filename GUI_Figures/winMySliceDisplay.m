function varargout = winMySliceDisplay(varargin)
% WINMYSLICEDISPLAY M-file for winMySliceDisplay.fig
%      WINMYSLICEDISPLAY, by itself, creates a new WINMYSLICEDISPLAY or raises the existing
%      singleton*.
%
%      H = WINMYSLICEDISPLAY returns the handle to a new WINMYSLICEDISPLAY or the handle to
%      the existing singleton*.
%
%      WINMYSLICEDISPLAY('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in WINMYSLICEDISPLAY.M with the given input arguments.
%
%      WINMYSLICEDISPLAY('Property','Value',...) creates a new WINMYSLICEDISPLAY or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before winSliceDisplay_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to winMySliceDisplay_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help winMySliceDisplay

% Last Modified by GUIDE v2.5 31-May-2017 15:10:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @winMySliceDisplay_OpeningFcn, ...
                   'gui_OutputFcn',  @winMySliceDisplay_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before winMySliceDisplay is made visible.
function winMySliceDisplay_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to winMySliceDisplay (see VARARGIN)

% Choose default command line output for winMySliceDisplay
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes winMySliceDisplay wait for user response (see UIRESUME)
% uiwait(handles.SLICEDISPLAY);


% --- Outputs from this function are returned to the command line.
function varargout = winMySliceDisplay_OutputFcn(hObject, eventdata, handles)
